...
const Banner = () => {
    return (
       ...
       <button className='bg-[#244D3F] px-[10px] py-[5px] rounded-md text-white'>+Add a Friend</button>
        </div>
        <div className='mb-[60px] container mx-auto gap-8 grid gap-2 grid-cols-2 lg:grid-cols-4'>
            <div className='flex flex-col justify-between items-center text-center shadow-md py-[20px] rounded-xl'>
                <h1 className='text-xl text-[#244D3F] font-bold'>10</h1>
                <p className='text-gray-500'>Friends</p>
            </div>
            <div className='flex flex-col justify-between items-center text-center shadow-md py-[20px] rounded-xl'>
                <h1 className='text-xl text-[#244D3F] font-bold'>3</h1>
                <p className='text-gray-500'>On Track</p>
            </div>
            <div className='flex flex-col justify-between items-center text-center shadow-md py-[20px] rounded-xl'>
                <h1 className='text-xl text-[#244D3F] font-bold'>6</h1>
                <p className='text-gray-500'>Need Attention</p>
            </div>
            <div className='flex flex-col justify-between items-center text-center shadow-md py-[20px] rounded-xl'>
                <h1 className='text-xl text-[#244D3F] font-bold'>12</h1>
